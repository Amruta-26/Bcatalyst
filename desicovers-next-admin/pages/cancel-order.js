...
export default function CancelOrder() {
    return (
        <div>
            <Typography variant="h4" gutterBottom style={{ textAlign: "center" }}>Cancellation</Typography><br />
            <div className="Container1">
                ...
                <div style={{ padding: "20px" }}>
                    <form action="/postcancel/" method="POST" className="form-control">
                        ...
                        <InputLabel id="cancelReason" style={{ color: "#000", fontSize: "16px" }}>Reason For Cancellation:</InputLabel>
                        <input type="hidden" value="{{order.id}}" name="id" />
        
                        <Select labelId="cancelReason" id="cars" value="3" className="form-control" name="cars">
                            <MenuItem value="1">Product is not required anymore.</MenuItem>
                            <MenuItem value="2">Product is being delivered to a wrong address(Customer’s mistake)</MenuItem>
                            <MenuItem value="3">Expected delivery date has changed and the product is arriving at a later date</MenuItem>
                            <MenuItem value="4">Cheaper alternative available for lesser price</MenuItem>
                            <MenuItem value="5">Bad review from friends/relatives after ordering the product</MenuItem>
                        ...
                        <Button variant="contained" sx={{ ml: 3 }}>Cancel Order</Button>
                    </form>
                </div>
            </div >
        </div >
