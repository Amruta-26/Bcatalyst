  ...
  return (
    <>
      ...
      <Typography variant="h4" gutterBottom component="div">
        <center>Add Title</center></Typography>
      ...
      >
        <div className="form-group">
          <label className="col-md-3 col-sm-3 col-xs-12 control-label" style={{ fontSize: "20px" }}>
            Company Name
          </label>
      ...
      <table id="gallery" className="table table-bordered">
        <thead className="thead-dark">
          <tr>
            <th style={{ textAlign: "left", fontSize: "14px" }}>Id</th>
